...
Modify the array job script to create a parameter sweep over the `-b | --bytes` size variable using non-consecutive array indicies and the `SLURM_ARRAY_TASK_ID` environment variable.
