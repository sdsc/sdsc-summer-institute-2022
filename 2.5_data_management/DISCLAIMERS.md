...
HPC and advanced CI run on Linux. If you don't believe me, then look no further than [the latest statistics from the TOP500](https://www.top500.org/statistics/list) --- a list of the most powerful supercomputers in the world. As such, this session will use --- *almost exclusively* --- command-line applications and tools that are commonly found on [Unix-like](https://en.wikipedia.org/wiki/Unix-like) operating systems such as Linux and macOS. While you will have remote access to a [(Rocky)](https://en.wikipedia.org/wiki/Rocky_Linux) Linux environment on Expanse via the XSEDE training account you were provided this week for the Summer Institute, you will also need access to a \*nix environment on your personal computer to complete some of the exercies we'll work through during this session. 
